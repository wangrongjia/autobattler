...
func _initialize() -> void:
	...
	assert(game.heroes.qunzhanghe.ability_params.gaolan_shield_bonus_mult == 0.60)
	assert(game.heroes.qunzhanghe.ability_params.four_pillars_shield_bonus_mult == 1.0)
