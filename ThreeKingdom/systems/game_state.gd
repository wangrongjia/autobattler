...
func _apply_existing_faction_skill_reworks() -> void:
	...
	_set_skill("sunjian", {"max_hp_cost":0.40, "damage_cost_ratio":1.0, "sun_legacy_current_hp_cost":0.80, "sun_legacy_damage_skill_ratio":0.15}, "猛虎绝命：消耗40%最大生命，攻击正前方敌军并造成等同于实际消耗生命100%的伤害。", "Tiger's Resolve: Spend 40% max HP and deal 100% of the HP actually spent to the facing enemy.")
