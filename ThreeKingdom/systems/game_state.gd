...
func _add_extended_roster() -> void:
	...
	_register_hero("xiaoqiao", "小乔", "Xiao Qiao", "wu", 165, 100, 6.2, 3, "Gentle Breeze", "天香缓阵", "signature", {"target_count":2, "slow_skill_ratio":0.35, "slow_time":6.0, "daqiao_slow_bonus_skill_ratio":0.12, "zhouyu_bonus_targets":1}, "天香缓阵：随机选择两名敌方后军，使其减速6秒，期间行动条速度降低0.35×兵略值%。", "Gentle Breeze: Slow two random enemy rearguards for 6s, reducing gauge speed by 0.35×Strategy%.")
...
func _apply_existing_faction_skill_reworks() -> void:
	...
	_set_skill("xiaoqiao", {"target_count":2, "slow_skill_ratio":0.35, "slow_time":6.0, "daqiao_slow_bonus_skill_ratio":0.12, "zhouyu_bonus_targets":1}, "天香缓阵：随机选择两名敌方后军，使其减速6秒，期间行动条速度降低0.35×兵略值%。", "Gentle Breeze: Slow two random enemy rearguards for 6s, reducing gauge speed by 0.35×Strategy%.")
	...
	_set_skill("xusheng", {"mult":1.0, "slow_skill_ratio":0.30, "slow_time":4.0, "bond_slow_time_bonus":3.0}, "宿卫水阵：冲击敌方前军整排，造成100%兵略值伤害，并留下4秒水阵，使该排行动速度降低0.3×兵略值%。", "Guardian Water Formation: Strike the enemy vanguard row for 100% Strategy and slow its gauge speed for 4s.")
