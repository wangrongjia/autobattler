...
const TREES := {
	...
	"huanggai": {
		...
		"role": [
			{"name": "苦肉", "desc": "每级使苦肉的生命转伤效率 +8%", "effects": {"skill_effect_pct": [0.2, 0.2]}},
			{"name": "老当益壮", "desc": "最大生命 +5%/级；提高生存与苦肉上限，但不会指数复利", "effects": {"max_hp_pct": [0.05, 0.05]}},
		...
		"branch": [
			{"name": "苦肉计", "desc": "进攻分支：苦肉生命转伤效率额外 +16%", "effects": {"skill_effect_pct": 0.4}},
			{"name": "老将稳重", "desc": "守势分支：生命消耗降低 50%，自身减伤 +15%", "effects": {"huanggai_cost_reduction_pct": 0.5, "taken_reduction_pct": 0.15}}],
		"bond": {"name": "老臣之心", "desc": "周瑜+黄盖 与 黄盖+孙坚组合效果 +15%/级", "effects": {"skill_effect_pct": [0.15, 0.15]}},
		"evergreen": {"name": "老当益壮·魂", "desc": "每级使自身造成伤害 +4%，以线性常驻成长结算", "effects": {"damage_pct": [0.04, 0.04]}},
